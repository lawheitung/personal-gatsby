	  ...
	  <>
	  	<div class='component-container'>
			...
			<section className="fencinglist">
				...
				< FencingPhoto
				img = {"../../fencing1.jpeg"} title={"Beginner"} description={"Picked up a foil at 8, fell in love ever since"}  
				/>
				< FencingPhoto
				img = {"../../fencing2.jpeg"} title={"Passion"} description={"Advanced the journey to a pro through high school and college"} 
				/>
				< FencingPhoto
				img = {"../../fencing4.jpeg"} title={"Giving Back"} description={"Continuing the journey in the community inspiring the younger generations"}
				/>
